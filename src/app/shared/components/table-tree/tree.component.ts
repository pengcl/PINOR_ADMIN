...
export function TreeServiceFactory(
...
@Component({
  ...
  providers: [
    TreeService,
    {
      ...
      deps: [[new SkipSelf(), new Optional(), NzTreeHigherOrderServiceToken], TreeService]
    },
    {
...
export class TreeComponent extends NzTreeBase implements OnInit, OnDestroy, ControlValueAccessor, OnChanges {
